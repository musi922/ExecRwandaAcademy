...
const Account = () => {
  return (
    <div>
        ...
        <p1 style={{color: "white", fontSize:"22px"}}>Exec Rwanda academy</p1>
      ...
      <div className='div'>
        ...
        <h1 style={{color:"#3A4E50", fontSize: "19px", textAlign:"center", letterSpacing: "0.5px", marginTop:"2%"}}>For information, Registration for the 2021-2022 period for the Affirmation, Transfer of Parent/Guardian</h1></div>
