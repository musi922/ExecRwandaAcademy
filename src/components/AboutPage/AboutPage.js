...
80% of students excel at regional, national and global levels
    ...
    <div className='footer' style={{marginTop:"56%"}}>
        ...
        <div className='footer2'>
          ...
          <div className='fifth'>
             <button className='view'>
              <a style={{color: "white", textDecoration: "none"}} href="https://www.google.com/maps/place/Richard+Code+Genius/@-1.9604883,30.063312,15z/data=!4m6!3m5!1s0x26fd8ea5a278de83:0x2d3f47f4185dc3f6!8m2!3d-1.9604883!4d30.063312!16s%2Fg%2F11sv_fflpk?entry=ttu" target={"_blank"}>View map <CiLocationOn style={{color: "white", fontSize: "22px"}}/></a>
               </button> 
          </div>
        </div>
        <div className='footer3'>
          ...
          <div>
            <h1 style={{color: "#0193DC", marginTop: "2%", marginLeft: "1%"}}>Exec RwandaAcademy<br></br><span style={{color:"white"}}>Transformed For Community</span></h1>
